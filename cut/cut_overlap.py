...
#***********************************************************#
with open('cut_curve1.txt', 'w') as f1:
    for pt in curve1:
...
with open('cut_curve2.txt', 'w') as f2:
    for pt in curve2:
        if pt[0] > pt3_right_NN[0] or pt[0] > pt4_right_NN[0]:
            out_coord = str(pt[0]) + ' ' + str(pt[1]) + ' ' + str(pt[2])
            f2.write(out_coord)
            f2.write('\n')

with open('cut_curve3.txt', 'w') as f3:
    for pt in curve3:
...
with open('cut_curve4.txt', 'w') as f4:
    for pt in curve4:
...
with open('cut_merge.txt', 'w') as f:
    for pt in curve1:
        if pt[0] < pt4_left_NN[0] or pt[0] < pt3_left_NN[0]:
            out_coord = str(pt[0]) + ' ' + str(pt[1]) + ' ' + str(pt[2])
            f.write(out_coord)
